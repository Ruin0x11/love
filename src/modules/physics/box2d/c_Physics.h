...
LOVE_EXPORT LoveC_Result love_physics_newRevoluteJoint(LoveC_Physics_BodyRef body1, LoveC_Physics_BodyRef body2, float xA, float yA, float xB, float yB, LoveC_Bool collideConnected, LoveC_Physics_RevoluteJointRef* outRevoluteJoint, char **outError);
LOVE_EXPORT LoveC_Result love_physics_newRevoluteJoint__referenceAngle(LoveC_Physics_BodyRef body1, LoveC_Physics_BodyRef body2, float xA, float yA, float xB, float yB, LoveC_Bool collideConnected, float referenceAngle, LoveC_Physics_RevoluteJointRef* outRevoluteJoint, char **outError);
