...
LOVE_EXPORT LoveC_Bool love_font_newBMFontRasterizer(LoveC_FileDataRef fileData, LoveC_Image_ImageDataRef** images, float dpiscale, LoveC_Font_RasterizerRef* outRasterizer, char** outError);
LOVE_EXPORT LoveC_Bool love_font_newImageRasterizer(LoveC_Image_ImageDataRef imageData, const char* glyphs, int extraspacing, float dpiscale, LoveC_Font_RasterizerRef* outRasterizer, char** outError);
